    ...
    <>
      ...
      <div id="seg-0" className="row position-relative" style={{ marginInline: "-3rem;" }}>
        ...
        <div className="ps-5 position-relative overflow-hidden mt-high w-100 container header-cont">
          <div className="px-3 px-lg-0 w-lg-50">
            <div className={`text-uppercase text-xlarge text-narrow-height mt-high ${GoodTimes.className}`}>
              <h1 className={`text-uppercase text-xlarge text-narrow-height appear2 ${GoodTimes.className}`}
            ...
            <a data-query="home.header.button._" data-attribute="href" className="appear2"
              ...
              <button
                className={`box btn text-medium text-thin bg-blue btn-xpadding mb-high text-oxford ${GoodTimes.className}`}>{homeCopy.header.button.name}</button>
            </a>
          </div>
        </div>
      </div>
      <div className="container ">
        ...
        <div id="our-mission" className="text-center mb-high mt-high">
          <h2 className={`${GoodTimes.className} appear2`} data-query="home.segment-1.title" dangerouslySetInnerHTML={{ __html: homeCopy.segment_1.title }}></h2>
        ...
        <div id="seg-1" className="row white-border bb-half">
          <div>
            <h2 className={`text-large text-narrow-height text-center mt-high text-uppercase appear2 home-segment-2-title ${GoodTimes.className}`}
          ...
          <div className="row p-0 m-0 mt-high">
            <div
              ...
              <div>
                <h5 className={`text-uppercase text-medium text-narrow-height my-3 mt-4 appear4 ${GoodTimes.className}`}
        ...
        <div className="row text-center">
          <div className="col-12 white-border bt-half bb-half p-lg-5 d-flex justify-content-center"
            id="bg-dots-tunnel">
            <h3 className={`text-medium mt-high mb-high w-70 text-thin appear2 ${GoodTimes.className}`}
        ...
        <div id="seg-2" className="row white-border bt-half bb-half position-relative overflow-hidden">
          <div className="p-5 m-0">
            <h2 className={`text-xlarge text-narrow-height text-center mt-high appear2 ${GoodTimes.className}`}
          ...
          <div className="row m-0 align-center justify-content-center pb-3 impact-container">
            ...
            <div className="col-12 col-lg-4 px-4 mt-5">
              <h4 className={`text-medium  text-center appear4 ${GoodTimes.className}`}
        ...
        <div id="seg-3" style={{
          ...
          <h2 className={`mt-5 appear2" data-query="home.segment-5.title ${GoodTimes.className}`} dangerouslySetInnerHTML={{ __html: homeCopy.segment_5.title }}></h2>
          ...
          <div className="mx-auto px-md-5" >
            <div className="row justify-content-between position-relative mt-high mb-lg-high">
              ...
              <div className="col-lg-3 col-12 ms-lg-10">
                <h4 className={`text-medium text-start appear4 ${GoodTimes.className}`}
            ...
            <div className="row justify-content-between mt-lg-high">
              ...
              {/* <!-- 4 --> */}
              <div className="col-lg-3 col-12 ">
                <h4 className={`text-medium text-start appear4 ${GoodTimes.className}`} style={{ width: "max-content;" }}
          ...
          <div className="col-md-8 d-flex flex-column justify-content-center px-5 white-border br-half bb-half bt-half position-relative overflow-hidden">
            <div className="pt-5 pt-lg-0">
              <div className={`text-uppercase text-xxlarge text-narrow-height ${GoodTimes.className}`} >
                <h1 className={`text-uppercase text-xxlarge text-narrow-height appear2 ${GoodTimes.className}`}
